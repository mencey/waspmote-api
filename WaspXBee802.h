...
class WaspXBee802 : public WaspXBeeCore
{
  public:
	...
	\param uint8_t protocol_used : specifies the protocol used in the XBee module (XBEE_802_15_4 in this case)
	...
	//! It sets the minimun value of the back-off exponent in CSMA/CA
  	/*!
	\param uint8_t exponent : specifies the value of the back-off exponent in CSMA/CA (range [0-3]) 
	\return '0' on success, '1' otherwise
	 */
	...
	//! It sets the CA threshold in the CCA process to detect energy on the channel
  	/*!
	\param uint8_t threshold : specifies the CA threshold in the CCA process to detect energy on the channel (range [0x00-0x50]) 
	\return '0' on success, '1' otherwise
	 */
