...
char* WaspRTC::getAlarm1()
{
	...
	sprintf(aux, "%d, %d:%d:%d - %d:%d:%d", date, year, month, day_alarm1, hour_alarm1, minute_alarm1, second_alarm1);
	return aux;
}
...
char* WaspRTC::getAlarm2()
{
	...
	readRTC(RTC_ALARM2_ADDRESS);
	sprintf (aux, "%d, %d:%d:%d - %d:%d", date, year, month, day_alarm2, hour_alarm2, minute_alarm2);
	return aux;
}
