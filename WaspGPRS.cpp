...
*/
uint8_t WaspGPRS::setPattern(const char* pattern)
{
	char command[25];
	char aux='"';
	uint8_t answer=0;
 ...
 * Returns '1' on success and '0' if error
*/
uint8_t WaspGPRS::setConnectionTimer()
{
	char command[25];
	char aux='"';
	uint8_t answer=0;
 ...
 * Returns '1' on success and '0' if error
*/
uint8_t WaspGPRS::setFlowControl()
{
	char command[25];
	char aux='"';
	uint8_t answer=0;
 ...
 * Returns '1' on success and '0' if error
*/
uint8_t WaspGPRS::writeData(const char* data)
{
	char command[GPRS_MAX_DATA+15];
...
*/
uint8_t WaspGPRS::parse_GSM(char* data)
{
	uint8_t a=0;
	char cmp[5];
 ...
 * Returns '1' on success and '0' if error
*/
uint8_t WaspGPRS::setEmailParams(char* smtp_server, uint16_t port, char* to)
{
	char command[100];
	char aux='"';
	uint8_t answer=0;
 ...
 * Returns '1' on success and '0' if error
*/
uint8_t WaspGPRS::setEmailPwd(char* user, char* pwd)
{
	char command[100];
	char aux='"';
	uint8_t answer=0;
 ...
 * Returns '1' on success and '0' if error
*/
uint8_t WaspGPRS::setEmailDestination(char* destination)
{
	char command[50];
	char aux='"';
	uint8_t answer=0;
 ...
 * Returns '1' on success and '0' if error
*/
uint8_t WaspGPRS::setEmailSubject(char* subject)
{
	char command[50];
	char aux='"';
	uint8_t answer=0;
...
byte WaspGPRS::sendATCommand(char* ATcommand, char* expectedAnswer) {
    return sendATCommand(ATcommand, expectedAnswer, 0);
}
  
byte WaspGPRS::sendATCommand(char* ATcommand, char* expectedAnswer, int sendOnce) {
...
byte WaspGPRS::sendCommand(char* theText, int endOfCommand, char* expectedAnswer) {
    return sendCommand(theText, endOfCommand, expectedAnswer, 0);
}

byte WaspGPRS::sendCommand(char* theText, int endOfCommand, char* expectedAnswer, int MAX_TIMEOUT, int sendOnce) {
    sprintf(theEnd, "%c", endOfCommand);
    return sendCommand(theText, theEnd, expectedAnswer, MAX_TIMEOUT, sendOnce);
}

byte WaspGPRS::sendCommand(char* theText, int endOfCommand, char* expectedAnswer, int sendOnce) {
    sprintf(theEnd, "%c", endOfCommand);
    return sendCommand(theText, theEnd, expectedAnswer, sendOnce);
}

byte WaspGPRS::sendCommand(char* theText, char endOfCommand, char* expectedAnswer) {
    return sendCommand(theText, (int) endOfCommand, expectedAnswer, 0);
}

byte WaspGPRS::sendCommand(char* theText, char endOfCommand, char* expectedAnswer, int MAX_TIMEOUT) {
...
byte WaspGPRS::sendCommand(char* theText, char* endOfCommand, char* expectedAnswer, int sendOnce) {
...
byte WaspGPRS::waitForData(char* expectedAnswer, int MAX_TIMEOUT, int timeout, int seconds) {
...
uint16_t WaspGPRS::waitForData(char* data, char* expectedAnswer)
{
	uint16_t i=0;
 ...
 * Returns '1' on success and '0' if error
*/
uint8_t WaspGPRS::sendSMS(const char* smsText, const char* tlfNumber)
{
	flag &= ~(GPRS_ERROR_SMS);
	flag &= ~(GPRS_ERROR_SMS);
	char command[25];
 ...
 * Returns '1' on success and '0' if error
*/
uint8_t WaspGPRS::uploadFile(char* file, char* path, char* user, char* passw, char* ftp_server, uint8_t ftp_port)
{
	char command[100];
	long previous=0;
	uint8_t answer=0;
