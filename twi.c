...
void twi_init(void)
{
  ...
  // allocate buffers
    for(i=0;i<TWI_BUFFER_LENGTH;i++) twi_masterBuffer[TWI_BUFFER_LENGTH]=0;
    for(i=0;i<TWI_BUFFER_LENGTH;i++) twi_txBuffer[TWI_BUFFER_LENGTH]=0;
    for(i=0;i<TWI_BUFFER_LENGTH;i++) twi_rxBuffer[TWI_BUFFER_LENGTH]=0;
...
// 	printString("Libero twi_masterBuffer",0);
// 	printNewline(0);
// 	free(twi_masterBuffer);
// 	twi_masterBuffer=NULL;
// 	printString("Libero twi_txBuffer",0);
// 	printNewline(0);
// 	free(twi_txBuffer);
// 	twi_txBuffer=NULL;
// 	printString("Libero twi_rxBuffer",0);
// 	printNewline(0);
// 	free(twi_rxBuffer);
// 	twi_rxBuffer=NULL;
}
